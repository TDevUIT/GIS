...
export class TrafficsController {
  ...
  @ApiOperation({ summary: 'Find traffic records intersecting with WKT geometry' })
  @ApiBody({ type: IntersectsWktDto, description: 'WKT geometry string' })
  @ApiResponse({ status: 200, description: 'Traffic records intersecting with the geometry' })
