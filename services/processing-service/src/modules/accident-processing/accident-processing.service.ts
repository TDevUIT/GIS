...
export class AccidentProcessingService {
  ...
  @RabbitSubscribe({
    ...
    routingKey: RoutingKeys.AccidentRawData,
  ...
  public async handleRawData(msg: RawAccidentData) {
    ...
    void this.amqpConnection.publish(
      Exchanges.Topic,
      RoutingKeys.AccidentCleanedData,
      cleanedData,
    );
  ...
  @RabbitSubscribe({
    exchange: Exchanges.Topic,
    routingKey: RoutingKeys.AccidentCleanedData,
  ...
  @RabbitSubscribe({
    exchange: Exchanges.Topic,
    routingKey: RoutingKeys.AccidentFinalData,
