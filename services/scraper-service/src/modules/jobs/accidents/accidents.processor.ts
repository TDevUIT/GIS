...
export class AccidentsProcessor extends WorkerHost {
  ...
  private async _extractDataWithGemini(
    ...
    try {
      ...
      - "description": string
      - "casualties": object (fatalities, injuries)
      - "vehiclesInvolved": array of strings
      - "coordinates": object hoặc null
