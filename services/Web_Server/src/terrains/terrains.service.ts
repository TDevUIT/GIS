...
export class TerrainsService {
  ...
  async create(createDto: any) {
    const url = `${this.gisServerUrl}/terrains`;
  ...
  async findOne(id: string) {
    const url = `${this.gisServerUrl}/terrains/${id}`;
    const response = await firstValueFrom(
  ...
  async findAtPoint(lng: string, lat: string) {
    const url = `${this.gisServerUrl}/terrains/at-point`;
    const response = await firstValueFrom(
      this.httpService
  ...
  async findIntersecting(wktBody: any) {
    const url = `${this.gisServerUrl}/terrains/intersects-with`;
    const response = await firstValueFrom(
