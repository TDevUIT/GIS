...
export class LandUsesService {
  ...
  async create(createDto: any) {
    const url = `${this.gisServerUrl}/land-uses`;
  ...
  async findOne(id: string) {
    const url = `${this.gisServerUrl}/land-uses/${id}`;
    const response = await firstValueFrom(
  ...
  async findAtPoint(lng: string, lat: string) {
    const url = `${this.gisServerUrl}/land-uses/at-point`;
    const response = await firstValueFrom(
      this.httpService
  ...
  async findIntersecting(wktBody: any) {
    const url = `${this.gisServerUrl}/land-uses/intersects-with`;
    const response = await firstValueFrom(
