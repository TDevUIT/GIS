...
export class WardsService {
  ...
  async findAll(districtId?: string) {
    const url = `${this.gisServerUrl}/wards`;
  ...
  async findOne(id: string) {
    const url = `${this.gisServerUrl}/wards/${id}`;
    const response = await firstValueFrom(
  ...
  async findContainingPoint(lng: string, lat: string) {
    const url = `${this.gisServerUrl}/wards/contains-point`;
    const response = await firstValueFrom(
      this.httpService
  ...
  async findIntersecting(wktBody: any) {
    const url = `${this.gisServerUrl}/wards/intersects-with`;
    const response = await firstValueFrom(
