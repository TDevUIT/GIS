            ...
            <tr>
                <td align="center" style="padding:24px 16px;">
                    <table
                        ...
                        cellspacing="0"
                        role="presentation"
                        style="background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(16,24,40,0.05);"
                    >
                        <tr>
                            <td style="padding:24px 32px;border-bottom:1px solid #eef2f7;">
                                <div style="display:flex;align-items:center;gap:12px;">
                                    <!-- THAY ĐỔI 1: Thay div bằng img -->
                                    <img
                                        src="https://res.cloudinary.com/dbonwxmgl/image/upload/v1759739740/EG_sj9np4.jpg"
                                        alt="EGis Logo"
                                        width="48"
                                        height="48"
                        ...
                        <tr>
                            <td style="padding:28px 32px;">
                                ...
                                <p style="margin:0 0 18px;color:#475569;line-height:1.5;font-size:14px;">
                                    An account has been created for you on the EGis system. Use the one-time password (OTP) below to sign in for the
                                    first time. You will be prompted to set a new password after signing in.
                                </p>
                                ...
                                <div style="margin:18px 0;padding:18px;background:#f8fafc;border-radius:8px;border:1px solid #e6eef6;text-align:center;">
                                    ...
                                    <div
                                        style="display:inline-block;padding:12px 18px;border-radius:6px;background:linear-gradient(180deg,#0ea5a4,#059669);color:#ffffff;font-weight:700;font-size:20px;letter-spacing:2px;"
                                    >
                                        ${otp}
                                    </div>
                                </div>
                                ...
                                <p style="margin:0 0 20px;color:#64748b;font-size:13px;">
                                    If you did not request this account or believe this email is in error, please contact your system administrator or reply to
                                    this message.
                                </p>

                                <div style="text-align:left;margin-top:8px;">
                                    <!-- THAY ĐỔI 2: Thay href="#" bằng dashboardUrl -->
                                    <a
                                        href="${dashboardUrl}"
                                        style="display:inline-block;padding:10px 16px;border-radius:6px;background:#0ea5a4;color:#ffffff;text-decoration:none;font-weight:600;font-size:14px;"
                                    >
                                        Go to EGis Dashboard
                                    </a>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding:16px 32px;background:#fbfdff;border-top:1px solid #eef2f7;font-size:12px;color:#94a3b8;">
                                <div style="display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap;">
                                    ...
                                    <div>
                                        Need help?
                                        <a href="mailto:support@egis.example" style="color:#0ea5a4;text-decoration:none;">support@egis.example</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
                    ...
                    <div style="max-width:600px;margin-top:12px;color:#94a3b8;font-size:12px;text-align:center;">
                        If the button doesn't work, copy and paste the OTP into the EGis login screen.
                    </div>
                </td>
            </tr>
        </table>
...
`;
  ...
  async sendPasswordResetLink(email: string, resetUrl: string): Promise<void> {
    const subject = 'EGis — Password Reset Request';
    const html = `
...
<a href="${resetUrl}" style="display:inline-block;padding:10px 16px;background:#0ea5a4;color:#ffffff;text-decoration:none;">Reset Your Password</a>
