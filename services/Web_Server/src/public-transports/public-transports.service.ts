...
export class PublicTransportsService {
  ...
  async create(createDto: any) {
    const url = `${this.gisServerUrl}/public-transports`;
  ...
  async findOne(id: string) {
    const url = `${this.gisServerUrl}/public-transports/${id}`;
    const response = await firstValueFrom(
  ...
  async findIntersecting(wktBody: any) {
    const url = `${this.gisServerUrl}/public-transports/intersects-with`;
    const response = await firstValueFrom(
