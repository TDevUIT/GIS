...
export default function AnalyticsPanel({ onClose }: AnalyticsPanelProps) {
  ...
  return (
    <div className="absolute top-4 right-4 w-96 bg-white rounded-lg shadow-lg border border-gray-200 z-[1000] max-h-[calc(100vh-2rem)] overflow-hidden flex flex-col">
      {/* Header */}
