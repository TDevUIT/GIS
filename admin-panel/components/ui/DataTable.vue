    ...
    <div class="overflow-x-auto rounded-lg border border-gray-700 bg-gray-800/50">
        <table class="min-w-full divide-y divide-gray-700">
            ...
            <tbody class="divide-y divide-gray-700/50 bg-gray-900/50">
                ...
                <tr v-for="item in data" :key="item.id" class="transition-colors hover:bg-gray-800/60">
                    <td v-for="column in columns" :key="column.key" class="whitespace-nowrap px-6 py-4 text-sm text-gray-300">
